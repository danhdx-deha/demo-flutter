...
class ChatBubbLess extends StatefulWidget {
  const ChatBubbLess({super.key});

  @override
  State<StatefulWidget> createState() => _ChatBubbLessState();
}

class _ChatBubbLessState extends State<ChatBubbLess> {
  late final List<Message> data;

  @override
  void initState() {
    super.initState();
    data = MessageGenerator.generate(10, 1337);
  }
